...
function GuessElement(props){
    ...
    return(
        <div className="flex items-center justify-center text-center">
            <div className={"flex flex-col items-center justify-center w-16 h-16 lg:w-20 lg:h-20 text-center " + ((props.element.status == status.correct) ? 'bg-green-500' : 'bg-red-500')}>
                ...
                <div className="p-0 text-5xl lg:text-5xl leading-[2rem]">
